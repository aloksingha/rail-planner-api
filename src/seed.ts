...
const ROUTES: [string, string, string, number, number, number][] = [
    ...
    ['GUWAHATI','KOCHI','GUWAHATI-KOCHI',4000,6000,7000],
    ['GUWAHATI','THIRUVANANTHAPURAM','GUWAHATI-THIRUVANANTHAPURAM',4000,6000,7000],
    ...
    ['DIBRUGARH','BANGALORE','DIBRUGARH-BANGALORE',4000,6000,7000],
    ['DIBRUGARH','CHENNAI','DIBRUGARH-CHENNAI',4000,6000,7000],
    ['DIBRUGARH','THIRUVANANTHAPURAM','DIBRUGARH-THIRUVANANTHAPURAM',4000,6000,7000],
    ...
    // North Bengal Hub
    ['NORTH_BENGAL','BANGALORE','NORTH_BENGAL-BANGALORE',3000,4500,5500],
    ['NORTH_BENGAL','CHENNAI','NORTH_BENGAL-CHENNAI',3000,4500,5500],
    ['NORTH_BENGAL','THIRUVANANTHAPURAM','NORTH_BENGAL-THIRUVANANTHAPURAM',3000,4500,5500],
